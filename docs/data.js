const GUESTS = [
  ...
  { name: "Iveth Castillo Moradkanian", table: 14, related: [] },
  { name: "Allen Moradkanian", table: 14, related: [] },
  { name: "Dylan Liu", table: 14, related: [] },
  ...
  { name: "Sarah Azarmi", table: 14, related: [] },
    ...
    { name: "Taylor Dorfmeister", table: 13, related: ["Sarah Azarmi", "Michael Azarmi"] },
