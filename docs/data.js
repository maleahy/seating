const GUESTS = [
  ...
  { name: "Emily Perkins", table: 8, related: ["Ute Perkins","Rebecca Perkins","Matthew Perkins","Jessica Perkins","Megan Noall","Jordan Noall"] },
  { name: "Alvin Yee", table: 9, related: [] },
    { name: "Faye Yee", table: 9, related: [] },
    { name: "Soonalote Tufele", table: 9, related: ["Ethan McElheny","Jayla McElheny"] },
  { name: "Spencer Yee", table: 9, related: ["Callie Yee", "Kendall Yee"] },
  { name: "Vivian Yee", table: 9, related: ["Callie Yee", "Kendall Yee"] },
    { name: "Cary Yee", table: 10, related: ["Nancy Yee"] },
    {name: "Nancy Yee", table: 10, related: ["Cary Yee"] },
